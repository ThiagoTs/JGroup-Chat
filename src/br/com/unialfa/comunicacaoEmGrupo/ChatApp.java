...
public class ChatApp extends Application {
	...
	private TextField txtNick = new TextField();
	...
	public void start(Stage stage) throws Exception {
		...
		txtNick.setPromptText("Digite seu nome");
		txtNick.isFocused();
	...
	private void sendMessage() {
		String msgAux = txtMessage.getText().trim();
		
		if(!msgAux.isEmpty() || !msgAux.equals("")){
			
			String msgStr = txtNick.getText() + " Disse:" + txtMessage.getText() + "\n";
